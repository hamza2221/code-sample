        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                        <form class="well form-horizontal" action="{{ route('admin.company.update', [$company->id])}}" method="post">
                            @method("put")
                            @csrf
                                ...
                                <div class="col-md-4 inputGroupContainer">
                                    <div class="input-group">
                                        ...
                                        <input name="person_name" placeholder="First Name" class="form-control"
                                            type="text" value="{{$company->person_name}}">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-4 inputGroupContainer">
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                        <input name="name" placeholder="Company Name" class="form-control" type="text" value="{{$company->name}}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4 inputGroupContainer">
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                        <input name="address1" placeholder="address1" class="form-control" type="text" value="{{$company->address1}}">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-md-4 inputGroupContainer">
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                        <input name="address2" placeholder="address2" class="form-control" type="text"  value="{{$company->address2}}">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-md-4 inputGroupContainer">
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                        <input name="address3" placeholder="address3" class="form-control" type="text" value="{{$company->address3}}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4 inputGroupContainer">
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                        <input name="n_t_n_number" placeholder="15 Digit code"
                                            class="form-control" type="text"  value="{{$company->n_t_n_number}}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4 inputGroupContainer">
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                        <input name="g_s_t_number" placeholder="15 Digit code"
                                            class="form-control" type="text"  value="{{$company->g_s_t_number}}">
                                    </div>
                                </div>
                            </div>
                            <!-- 
                                ...
                                <div class="col-md-4 inputGroupContainer">
                                    <div class="input-group">
                                        ...
                                        <input name="Remarks" placeholder="Anything......" class="form-control"
                                            type="text" value="{{$company->remarks}}">
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select name="product_id" class="form-control">
                                                @foreach ($products as $product)
                                                    <option value="{{ $product->id}}" @if($product->id == $company->product_id) selected @endif>{{$product->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-4 inputGroupContainer">
                                            <div class="input-group">
                                                ...
                                                <input name="purchase_amount" placeholder="0.00" class="form-control"
                                                    type="number"  value="{{$company->purchase_amount}}">
                                            </div>
                                        </div>
                                    </div>
                                    <!-- 
 ...
 -->
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <input name="landline_number" type="text" class="form-control"
                                                id="landline_number"  value="{{$company->landline_number}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <input name="srs_code" type="text" class="form-control" id="srs_code" value="{{$company->srs_code}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <select name="subscription_type" class="form-control">
                                                <option value="prepaid" @if($company->subscription_type == "prepaid") selected @endif>prepaid</option>
                                                <option value="postpaid" @if($company->subscription_type == "postpaid") selected @endif>postpaid</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <select name="courier" class="form-control">
                                                <option value="ums" @if($company->courier == "ums") selected @endif>UMS</option>
                                                <option value="byhand" @if($company->courier == "byhand") selected @endif>By Hand</option>
                                                <option value="email" @if($company->courier == "email") selected @endif>Email</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <select name="status" class="form-control">
                                                ...
                                                <option value="demo" @if($company->status == "demo") selected @endif>Demo</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4 inputGroupContainer">
                                        <input name="postal_name" type="text" class="form-control" id="postal_name" value="{{$company->postal_name}}">
                                    </div>
                                </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4 inputGroupContainer">
                                            <div class="input-group">
                                                ...
                                                <input name="postal_address1" placeholder="address1"
                                                    class="form-control" type="text" value="{{$company->postal_address1}}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-md-4 inputGroupContainer">
                                            <div class="input-group">
                                                ...
                                                <input name="postal_address2" placeholder="address2"
                                                    class="form-control" type="text" value="{{$company->postal_address2}}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-md-4 inputGroupContainer">
                                            <div class="input-group">
                                                ...
                                                <input name="postal_address3" placeholder="address3"
                                                    class="form-control" type="text" value="{{$company->postal_address3}}">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-4 inputGroupContainer">
                                            <div class="input-group">
                                                ...
                                                <input name="nick_name" placeholder="Nick Name" class="form-control"
                                                    type="text" value="{{$company->nick_name}}">
                                            </div>
                                        </div>
                                    </div>
                                    <!-- <div class="col-4">
                                        ...
                                        <div class="col-md-4 inputGroupContainer">
                                            <div class="input-group">
                                                ...
                                                <input name="nick_address1" placeholder="address1" class="form-control"
                                                    type="text" value="{{$company->nick_address1}}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-md-4 inputGroupContainer">
                                            <div class="input-group">
                                                ...
                                                <input name="nick_address2" placeholder="address2" class="form-control"
                                                    type="text" value="{{$company->nick_address2}}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-md-4 inputGroupContainer">
                                            <div class="input-group">
                                                ...
                                                <input name="nick_address3" placeholder="address3" class="form-control"
                                                    type="text" value="{{$company->nick_address3}}">
                                            </div>
                                        </div>
                                    </div>
